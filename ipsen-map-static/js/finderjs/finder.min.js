(function(f) {
  ...
  return (function e(t, n, r) {
    ...
    {
      "/Users/mmatyas/projects/finderjs/index.js": [
        function(require, module, exports) {
          "use strict";
          function finder(e, t, n) {
            var i = new EventEmitter(),
              a = extend(defaults, { container: e, emitter: i }, n);
            return (
              (a.className = extend(defaults.className, n ? n.className : {})),
              "function" == typeof t && (a.data = t),
              e.addEventListener(
                "click",
                finder.clickEvent.bind(null, e, a, i)
              ),
              e.addEventListener(
                "keydown",
                finder.keydownEvent.bind(null, e, a, i)
              ),
          ...
          (module.exports = finder),
            (finder.addColumn = function(e, t, n, i) {
              e.appendChild(i), n.emit("column-created", i);
            }),
            (finder.itemSelected = function(e, t, n) {
              var i = n.item,
                a = i._item,
                l = n.col,
                r = a[e.childKey] || e.data,
              ...
              s.length && _.removeClass(s[0], e.className.active),
                ...
                window.scrollTo(c, d),
                r
                  ? (finder.createColumn(r, e, t, a),
                    t.emit("interior-selected", a))
                  : a.url
                  ? (document.location.href = a.url)
                  : t.emit("leaf-selected", a);
            }),
            (finder.clickEvent = function(e, t, n, i) {
              var a = i.target,
                l = _.closest(a, function(e) {
                  return _.hasClass(e, t.className.col);
                }),
                r = _.closest(a, function(e) {
                  return _.hasClass(e, t.className.item);
                });
              _.stop(i),
                r && n.emit("item-selected", { container: e, col: l, item: r });
            }),
            (finder.keydownEvent = function(e, t, n, i) {
              var a = { 38: "up", 39: "right", 40: "down", 37: "left" };
              i.keyCode in a &&
                (_.stop(i),
                n.emit("navigate", { direction: a[i.keyCode], container: e }));
            }),
            (finder.navigate = function(e, t, n) {
              var i,
                a,
                l = finder.findLastActive(n.container, e),
                r = null,
                s = n.direction;
              l
                ? ((i = l.item),
                  (a = l.col),
                  "up" === s && i.previousSibling
                    ? (r = i.previousSibling)
                    : "down" === s && i.nextSibling
                    ? (r = i.nextSibling)
                    : "right" === s && a.nextSibling
                    ? ((a = a.nextSibling),
                    ...
                    : "left" === s &&
                      ...
                      ((a = a.previousSibling),
                      (r =
                        _.first(a, "." + e.className.active) ||
                        _.first(a, "." + e.className.item))))
                : ((a = _.first(n.container, "." + e.className.col)),
                  (r = _.first(a, "." + e.className.item))),
                r &&
                  t.emit("item-selected", {
            ...
            (finder.findLastActive = function(e, t) {
              var n,
                i,
                a = e.getElementsByClassName(t.className.active);
              return a.length
                ? ((n = a[a.length - 1]),
            ...
            (finder.createColumn = function(e, t, n, i) {
              ...
              if ("function" == typeof e)
                e.call(null, i, t, function(e) {
                  finder.createColumn(e, t, n, i);
                });
              else {
                if (!isArray(e)) throw new Error("Unknown data type");
                (l = finder.createList(e, t)),
                  (a = _.el("div")).appendChild(l),
                  _.addClass(a, t.className.col),
                  n.emit("create-column", a);
              }
            }),
            (finder.createList = function(e, t) {
              ...
              return (
                (n = e
                  .map(finder.createItem.bind(null, t))
                  .reduce(function(e, t) {
            ...
            (finder.createItemContent = function(e, t) {
              ...
              return (
                n.appendChild(i),
                a.appendChild(document.createTextNode(t[e.labelKey])),
                n.appendChild(a),
                n.appendChild(l),
                n
              );
            ...
            (finder.createItem = function(e, t) {
              var n = document.createDocumentFragment(),
                ...
                l = _.el("a");
              return (
                (n = (e.createItemContent || finder.createItemContent).call(
                  null,
                  e,
                  t
                )),
                ...
                t.url && ((l.href = t.url), i.push(e.className.url)),
                t.className && i.push(t.className),
                t[e.childKey] && i.push(e.className[e.childKey]),
                _.addClass(a, i),
                a.appendChild(l),
                (a._item = t),
                a
        ...
        },
        {
          ...
          eventemitter3:
            "/Users/mmatyas/projects/finderjs/node_modules/eventemitter3/index.js",
          "global/document":
            "/Users/mmatyas/projects/finderjs/node_modules/global/document.js",
          "global/window":
            "/Users/mmatyas/projects/finderjs/node_modules/global/window.js",
          "x-is-array":
            "/Users/mmatyas/projects/finderjs/node_modules/x-is-array/index.js",
          xtend:
            "/Users/mmatyas/projects/finderjs/node_modules/xtend/immutable.js"
        }
      ],
      "/Users/mmatyas/projects/finderjs/node_modules/browser-resolve/empty.js": [
        function(require, module, exports) {},
        {}
      ],
      "/Users/mmatyas/projects/finderjs/node_modules/eventemitter3/index.js": [
        function(require, module, exports) {
          ...
          Object.create &&
            ...
            (EventEmitter.prototype.emit = function(e, t, n, r, s, i) {
              ...
              if (h.fn) {
                switch (
                  (h.once && this.removeListener(e, h.fn, void 0, !0), c)
                ) {
                  case 1:
                ...
                for (f = 0; f < a; f++)
                  switch (
                    (h[f].once && this.removeListener(e, h[f].fn, void 0, !0),
                    c)
                  ) {
                    case 1:
              ...
              if (i.fn)
                ...
                for (var o = 0, v = [], f = i.length; o < f; o++)
                  (i[o].fn !== t ||
                    ...
                    v.push(i[o]);
                v.length
                  ? (this._events[s] = 1 === v.length ? v[0] : v)
                  : 0 == --this._eventsCount
                  ? (this._events = new Events())
                  : delete this._events[s];
              }
      ...
      "/Users/mmatyas/projects/finderjs/util.js": [
        function(require, module, exports) {
          "use strict";
          ...
          function el(e) {
            ...
            return isElement(e)
              ? e
              : ((s = e.split(".")).length > 1 && (n = s[0]),
                (r = document.createElement(n)),
                addClass(r, s.slice(1)),
                r);
          }
          function frag() {
          ...
          function hasClass(e, r) {
            return (
              !!(e && "className" in e) &&
              -1 !== e.className.split(/\s+/).indexOf(r)
            );
          }
          function nextSiblings(e) {
            for (var r = e.nextSibling, s = []; r; )
              s.push(r), (r = r.nextSibling);
            return s;
          }
          function previousSiblings(e) {
            for (var r = e.previousSibling, s = []; r; )
              s.push(r), (r = r.previousSibling);
            return s;
          }
          function stop(e) {
          ...
          function append(e, r) {
            var s = frag();
            return (
              (r = isArray(r) ? r : [r]).forEach(s.appendChild.bind(s)),
              e.appendChild(s),
              e
            );
          }
